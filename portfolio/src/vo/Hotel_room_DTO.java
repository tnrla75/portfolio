...
public class Hotel_room_DTO {
	...
	private String hot_room_wifi;
	private String hot_room_airCon;
	private String hot_room_shower;
	private String hot_room_refrigerator;
	private String hot_room_TV;
	private String hot_room_bathtud;
	private String hot_room_breakfast;
	private String hot_room_Nobreakfast;
	private String hot_room_parking;
	private String hot_room_Noparking;
	...
	public String getHot_room_wifi() {
		return hot_room_wifi;
	}
	public void setHot_room_wifi(String hot_room_wifi) {
		this.hot_room_wifi = hot_room_wifi;
	}
	public String getHot_room_airCon() {
		return hot_room_airCon;
	}
	public void setHot_room_airCon(String hot_room_airCon) {
		this.hot_room_airCon = hot_room_airCon;
	}
	public String getHot_room_shower() {
		return hot_room_shower;
	}
	public void setHot_room_shower(String hot_room_shower) {
		this.hot_room_shower = hot_room_shower;
	}
	public String getHot_room_refrigerator() {
		return hot_room_refrigerator;
	}
	public void setHot_room_refrigerator(String hot_room_refrigerator) {
		this.hot_room_refrigerator = hot_room_refrigerator;
	}
	public String getHot_room_TV() {
		return hot_room_TV;
	}
	public void setHot_room_TV(String hot_room_TV) {
		this.hot_room_TV = hot_room_TV;
	}
	public String getHot_room_bathtud() {
		return hot_room_bathtud;
	}
	public void setHot_room_bathtud(String hot_room_bathtud) {
		this.hot_room_bathtud = hot_room_bathtud;
	}
	public String getHot_room_breakfast() {
		return hot_room_breakfast;
	}
	public void setHot_room_breakfast(String hot_room_breakfast) {
		this.hot_room_breakfast = hot_room_breakfast;
	}
	public String getHot_room_Nobreakfast() {
		return hot_room_Nobreakfast;
	}
	public void setHot_room_Nobreakfast(String hot_room_Nobreakfast) {
		this.hot_room_Nobreakfast = hot_room_Nobreakfast;
	}
	public String getHot_room_parking() {
		return hot_room_parking;
	}
	public void setHot_room_parking(String hot_room_parking) {
		this.hot_room_parking = hot_room_parking;
	}
	public String getHot_room_Noparking() {
		return hot_room_Noparking;
	}
	public void setHot_room_Noparking(String hot_room_Noparking) {
		this.hot_room_Noparking = hot_room_Noparking;
	}
