...
public class FlightFilterAction_go implements Action  {
	public ActionForward execute(HttpServletRequest request,HttpServletResponse response) throws Exception{ 
		...
		article1 = FlightFilterService.getArticle_fliter_go(departure, arrive, people, seat, departureday , startleftval1 , startrightval1 , startleftval2 , startrightval2 ,  page1, limit, arr);
		listCount=FlightFilterService.getListCountFilter_go(departure, arrive, people, seat, departureday, startleftval1 , startrightval1 , startleftval2 , startrightval2 , arr);
		...
		ActionForward forward = new ActionForward();	
 		forward.setPath("/flight/ticket_filterlist_go.jsp");
