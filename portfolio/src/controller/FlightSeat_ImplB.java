...
public class FlightSeat_ImplB implements CommandInter {

	static FlightSeat_ImplB impl = new FlightSeat_ImplB();

	public static FlightSeat_ImplB instance(){
		return impl;
	}
...
//	액션의 용도, DB로 연결하는 service로 감
	...
	public String showData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(bool == null) {
			...
			return "flight_seatB737_1.jsp";
		}
		else {
			request.setAttribute("seat2", seat2);
			return "flight_seatB737_2.jsp";
		}
	}
}
